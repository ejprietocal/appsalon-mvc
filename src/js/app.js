...
function iniciarApp(){
    ...
    mostrarSeccion(); //muestrsa y coulta las secciones
    tabs();//cambia las funciones cuando se presionen los tabs
...
function seleccionarServicio(servicio){
    ...
    if(servicios.some(agregado => agregado.id === id)){
        ...
        //Agregarlo
        cita.servicios = [...servicios, servicio]; //toma una copia y reescribe
